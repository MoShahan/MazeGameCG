...
void frontscreen(void)
{
    ...
    glColor3f(1,1,1);
	output(50,160," P.A COLLEGE OF ENGINEERING ");
	glColor3f(1,1,1);
	output(10.0,150," DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING ");
	glColor3f(1,0.5,0.5);
	output(60,130," A Mini Project On: ");
	glColor3f(0.7,1,0.5);
	output(53.5,120,"\" A Simple Maze Game \" ");
	glColor3f(0.687,0.255,1);
	output(40,100," By : ");
	glBegin(GL_LINES);
	glVertex2f(40,98);
	glVertex2f(50,98);
	glEnd();
	glColor3f(0,0.68,0.255);
	output(60,90," Mohammed Shahan\n");
	output(60,80," Mohammed Mubashir ");
	output(40,80,"");
	...
	output(40,50,"");
	glColor3f(1,0,0);
	//drawstring(72,50," Ms. Avvanhi ",GLUT_BITMAP_HELVETICA_12);
	output(60,50," Ms. Avvanhi ");
	glColor3f(1,0,0);
	//output(70,40," Assistant Professor, Dept. of CSE ");
	drawstring(85,45," - Assistant Professor, Dept. of CSE ",GLUT_BITMAP_HELVETICA_12);
	glColor3f(1,0,0);
	output(40,30,"");
	glColor3f(1,0,0);
	//drawstring(72,30," Ms. Divya Jithesh ",GLUT_BITMAP_HELVETICA_12);
	output(60,30," Ms. Divya Jithesh ");
	//output(70,20,"Assistant Professor, Dept. of CSE");
	drawstring(85,25," - Assistant Professor, Dept. of CSE",GLUT_BITMAP_HELVETICA_12);
	glFlush();
